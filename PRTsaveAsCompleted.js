      ...
      const updateInventory = async (data, plantId, organizationId) => {
        ...
        const updateWeightedAverage = (item, batchId) => {
          ...
          if (
            ...
            console.error(
              "Invalid item data for weighted average update:",
              item
            );
          ...
          return query
            ...
            .then((waResponse) => {
              ...
              const calculatedWaCostPrice =
                (waCostPrice * waQuantity - waCostPrice * returnQty) /
                newWaQuantity;
        ...
        if (Array.isArray(items)) {
          for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            try {
              ...
              if (temporaryData.length > 0) {
                for (const temp of temporaryData) {
                  ...
                  if (temp.batch_id) {
                    ...
                    const existingBatchDoc = hasBatchBalance
                      ? batchResult[0]
                      : null;
                    ...
                    if (existingDoc && existingDoc.id) {
                      ...
                      console.log(
                        `Updated balance for item ${item.material_id}`
                      );
                    } else {
                      console.log(
              ...
              console.error(
                `Error processing item ${item.material_id}:`,
                error
              );
            }
          }
          ...
          try {
            ...
            if (page_status === "Add") {
              ...
              const purchaseReturnId =
                this.getParamsVariables("purchase_return_no");
