        ...
        const prefixEntry = await db
          ...
          .then((prefixEntry) => {
            ...
            const findUniquePrefix = async () => {
              ...
              if (!isUnique) {
                throw new Error(
                  "Could not generate a unique Sales Orders number after maximum attempts"
                );
              }
