    ...
    const newRows = selected.map((dialogRow) => {
      ...
      const preexistingEntries = huItems.map((it, idx) => {
        ...
        return {
          ...
          item_code: master.material_code || master.item_code || it.material_id,
          item_name: master.material_name || master.item_name || "",
          item_desc: master.material_desc || master.item_desc || "",
          item_uom: master.based_uom || master.item_uom || "",
