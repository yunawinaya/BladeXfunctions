      ...
      for (const selectedRecord of selectedRecords) {
        ...
        for (const item of tablePickingItems) {
              ...
              for (const gdTempQtyItem of gdTempQtyData) {
                if (
                  ...
                  if (gdTempQty !== qtyToPick) {
                    this.$message.error(
                      `The quantity to pick (${qtyToPick}) is not equal to the GD quantity (${gdTempQty}) for Picking ${pickingNumber}.`
                    );
                    return;
                  }
                  ...
                  console.log(
                    `Picking ${pickingNumber}: Updated GD ${
                      gdData.gd_id
                    } temp_qty_data - Location: ${locationId}, Batch: ${
                      batchId || "N/A"
          ...
          if (gdDataUpdated) {
            ...
            await updateOnReserveGoodsDelivery(gdData.organization_id, gdData);
          }
        }
      }
