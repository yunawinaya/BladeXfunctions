  ...
  try {
    ...
    rows.forEach((row, idx) => {
      if (
        ...
        let pickedQty = 0;
        // Order-UOM (item_uom) quantity being picked — the weight factor is
        // defined per item_uom, so it uses this, not the picking_uom value.
        ...
        // Live net weight from the order-UOM picked qty (the workflow
